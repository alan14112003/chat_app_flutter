...
class AddFriend implements UseCase<void, AddFriendParrams> {
  ...
  @override
  Future<Either<Failure, void>> call(AddFriendParrams params) async {
    try {
      await _friendRepository.addFriendById(params.friendId);
      return Right(null);
